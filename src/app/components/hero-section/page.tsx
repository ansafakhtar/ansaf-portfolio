...
const HeroSection = () => {
  ...
  useGSAP(
    () => {
      ...
      const greetingTitles = personalData.greeting;
      let index = 0;
      ...
      // Greeting Rotation Animation
      const runGreetingAnimation = () => {
        const el = greetingRef.current;
        if (!el) return;

        const tl = gsap.timeline({
          onComplete: () => {
            index = (index + 1) % greetingTitles.length;
            runGreetingAnimation();
          },
        });

        el.textContent = greetingTitles[index];
        ...
        <div className="order-2 lg:order-1 flex flex-col items-start gap-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="hero-heading text-lg md:text-xl text-slate-400 max-w-xl leading-relaxed font-medium">
              <span
                ...
                ref={greetingRef}
              >
                {personalData.greeting[0]}
              </span>
            </p>
            <p className="hero-heading text-lg md:text-xl text-slate-400 max-w-xl leading-relaxed font-medium">
              I'm <span className="text-white font-bold">{personalData.name}</span>, a professional
              <span
                className="text-blue-500 ml-2 font-bold inline-block min-w-[200px]"
                ref={designationRef}
              >
                {personalData.designationAlternateWords[0]}
              </span>
              <br />I build high-performance, user-centric web applications.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="hero-cta flex flex-wrap gap-4">
              <Link
                href="/#contact"
                className="group relative px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-900 text-white font-bold uppercase tracking-wider overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(21,93,252,0.3)]"
              >
                ...
                <code className="font-mono text-xs md:text-sm lg:text-base leading-relaxed">
                  ...
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-blue-300">'Ansaf Akhtar'</span>,
                    </p>
                  </div>
                  <div className="flex gap-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-blue-300">
                        'ReactJS', 'JavaScript', 'TypeScript', 'NextJS', 'Node', 'AWS'
                      </span>
                      ],
                    </p>
                  </div>
