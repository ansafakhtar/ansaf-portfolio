          ...
          <CardFooter className="p-6 pt-2 flex gap-4">
            {project.demo ? (
              <a href={project.demo} target="_blank" rel="noopener noreferrer" className="flex-1">
                <div className="w-full h-11 rounded-xl text-xs font-bold uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-2 border border-white/10 bg-white/5 hover:bg-red-600 text-white hover:border-red-500 shadow-xl hover:shadow-red-600/20">
            ...
            {project.code ? (
              <a href={project.code} target="_blank" rel="noopener noreferrer" className="flex-1">
                <div className="w-full h-11 rounded-xl text-xs font-bold uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-2 border border-white/10 bg-white/5 hover:bg-red-950 text-white hover:border-red-800 shadow-xl hover:shadow-red-950/20">
