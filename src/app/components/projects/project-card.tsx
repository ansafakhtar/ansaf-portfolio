"use client";
import { /* Button removed to avoid nested interactive elements */ } from "@/components/ui/button";
          ...
          <CardFooter className="p-6 pt-2 flex gap-4">
            {project.demo ? (
              <a href={project.demo} target="_blank" rel="noopener noreferrer" className="flex-1">
                <div className="w-full h-11 rounded-xl text-xs font-bold uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-2 border border-white/10 bg-white/5 hover:bg-blue-600 text-white hover:border-blue-500 shadow-xl hover:shadow-blue-600/20">
                  <Globe className="w-4 h-4" />
                  Live Demo
                </div>
              </a>
            ) : (
              <div className="w-full h-11 rounded-xl text-xs font-bold uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-2 bg-white/2 text-slate-800 cursor-not-allowed border-none flex-1">
                <Globe className="w-4 h-4" />
                Live Demo
              </div>
            )}
            ...
            {project.code ? (
              <a href={project.code} target="_blank" rel="noopener noreferrer" className="flex-1">
                <div className="w-full h-11 rounded-xl text-xs font-bold uppercase tracking-widest transition-all duration-300 flex items-center justify-center gap-2 border border-white/10 bg-white/5 hover:bg-blue-950 text-white hover:border-blue-800 shadow-xl hover:shadow-blue-950/20">
