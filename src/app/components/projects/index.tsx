    ...
    >
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="flex flex-col items-center gap-12 lg:gap-20">
          ...
          >
            <div className="relative px-10 py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-900 text-white font-bold uppercase tracking-widest text-sm transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(21, 93, 252,0.3)] flex items-center gap-2 overflow-hidden">
