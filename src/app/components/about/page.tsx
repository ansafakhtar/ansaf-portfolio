    ...
    <div id="about" className="relative py-24 lg:py-48 overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-12 lg:gap-24 items-center">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3 text-blue-500 mb-2">
                <div className="w-10 h-10 rounded-xl bg-blue-500/10 flex items-center justify-center">
                  <User className="w-5 h-5 shadow-[0_0_15px_rgba(21,93,252,0.5)]" />
                </div>
                <span className="text-sm font-bold uppercase tracking-[0.3em]">Discovery</span>
              </div>
          ...
          <div className="lg:col-span-3 order-1 lg:order-2 scale-90">
            <Tilt
              perspective={1500}
              glareEnable={true}
              glareMaxOpacity={0.2}
            ...
            >
              <div className="relative group">
                ...
                <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border-2 border-white/10 shadow-[0_0_50px_rgba(21,93,252,0.15)] bg-[#050505]">
                  <Image
